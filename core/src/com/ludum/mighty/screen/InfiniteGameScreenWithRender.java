...
import com.ludum.mighty.render.MightyRender;
 ...
 *
 */
public class InfiniteGameScreenWithRender extends DefaultScreen {
	 ...
	 * @param game
	 */
	public InfiniteGameScreenWithRender(Game game) {
		super(game);
		...
		this.mightyRender = new MightyRender(batcher, this.mWorld, gameAssets, Commons.WORLD_WIDTH, 
				Commons.WORLD_HEIGHT);	
	}
	...
	{
		if (this.mWorld.getEnemyStoppedVector().size() > Commons.MAX_ENEMIES)
		{
			MightyGame game = (MightyGame) this.mightyGame;
			
			game.setLastScore(this.mWorld.getCurrentScore());
